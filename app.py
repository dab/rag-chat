...
if uploaded_files:
    if len(uploaded_files) > MAX_FILES:
        ...
        # Display success message for valid files and update session state
        if valid_files:
        ...
        else: # Handle case where there were errors, clear session state
             st.session_state['valid_pdf_files'] = []
